...
?>
<!-- wp:group {"className":"alignfull", "align":"full","style":{"spacing":{"padding":{"top":"11vh","right":"var(--wp--custom--spacing--side)","bottom":"11vh","left":"var(--wp--custom--spacing--side)"},"margin":{"top":"0px","bottom":"0px"}}},"backgroundColor":"tile","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull has-tile-background-color has-background" style="margin-top:0px;margin-bottom:0px;padding-top:11vh;padding-right:var(--wp--custom--spacing--side);padding-bottom:11vh;padding-left:var(--wp--custom--spacing--side)"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"228px","textTransform":"uppercase","letterSpacing":"60px","lineHeight":".8"},"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"textColor":"primary","className":"is-style-vertical-on-mobile"} -->
