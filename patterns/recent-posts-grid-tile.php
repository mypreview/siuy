...
?>
<!-- wp:group {"className":"alignfull", "align":"full","style":{"spacing":{"padding":{"right":"var(--wp--custom--spacing--side)","left":"var(--wp--custom--spacing--side)","top":"70px","bottom":"50px"}}},"backgroundColor":"tile","layout":{"inherit":true}} -->
