...
!function(n,i,e){"use strict";if("#right.siuy-offcanvas".length>0&&(i(document).trigger("enhance"),i("#right.siuy-offcanvas").offcanvas({modifiers:"right,overlay,push",triggerButton:".js-primary-offcanvas-toggler",onInit:function(){i(this).removeClass("is-hidden")}}),i(".js-append-around").appendAround(),i(".menu-main-menu-container > #primary-menu").length>0&&(i(".menu-main-menu-container > #primary-menu").clone().appendTo(".c-offcanvas > #primary-slinky-menu"),i("#right.siuy-offcanvas #primary-slinky-menu").length>0)))i("#right.siuy-offcanvas #primary-slinky-menu").slinky();i(n).on("load resize scroll",function(){var e=i(".siuy-offcanvas"),r=Math.max(i(n).width(),n.innerWidth),a=i(n).scrollTop(),s=i("#wpadminbar");s.length&&(r>600?e.css("top",s.height()+"px"):r<=600&&a>=5?e.css("top","0"):r<=600&&a<=5&&e.css("top",s.height()+"px"))}),(i('iframe[src*="youtube"]').length>0||i('iframe[src*="vimeo"]').length>0||i('iframe[src*="soundcloud"]').length>0||i('iframe[src*="mixcloud"]').length>0)&&i('iframe[src*="youtube"], iframe[src*="vimeo"], iframe[src*="soundcloud"], iframe[src*="mixcloud"]').parent().fitVids()}(this,jQuery);