...
!function(i,r,e){"use strict";if("#right.siuy-offcanvas".length>0&&(r(document).trigger("enhance"),r("#right.siuy-offcanvas").offcanvas({modifiers:"right,overlay,push",triggerButton:".js-primary-offcanvas-toggler",onInit:function(){r(this).removeClass("is-hidden")}}),r(".js-append-around").appendAround(),r("#masthead #primary-menu").length>0&&(r("#masthead #primary-menu").clone().appendTo(".c-offcanvas > #primary-slinky-menu"),r("#right.siuy-offcanvas #primary-slinky-menu").length>0)))r("#right.siuy-offcanvas #primary-slinky-menu").slinky();r(i).on("load resize scroll",function(){var e=r(".siuy-offcanvas"),s=Math.max(r(i).width(),i.innerWidth),n=r(i).scrollTop(),a=r("#wpadminbar");a.length&&(s>600?e.css("top",a.height()+"px"):s<=600&&n>=5?e.css("top","0"):s<=600&&n<=5&&e.css("top",a.height()+"px"))}),(r('iframe[src*="youtube"]').length>0||r('iframe[src*="vimeo"]').length>0||r('iframe[src*="videopress"]').length>0||r('iframe[src*="soundcloud"]').length>0||r('iframe[src*="mixcloud"]').length>0)&&r('iframe[src*="youtube"], iframe[src*="vimeo"], iframe[src*="videopress"], iframe[src*="soundcloud"], iframe[src*="mixcloud"]').parent().fitVids()}(this,jQuery);